...
## Project Structure
    ...
    ├── testapiautostoryboa_84160  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_84160`
...
2. Clone this repo and `cd testapiautostoryboa_84160`
